    ...
    <div class="container mx-auto py-8">
        <div class="max-w-xl mx-auto bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="mb-4">
                ...
                <textarea v-model="question" id="question" rows="4" :class="{ 'border-red-500': errors.question }" required
                    minlength="2"
            ...
            <div class="mb-4">
                ...
                <div v-for="(option, index) in options" :key="index" class="flex items-center">
                    <input v-model="correctOptions" :value="index" :id="'correctOption' + index" type="checkbox"
                        class="mr-2">
            ...
            <div class="mb-4">
                <button @click.prevent="addImage"
                    class="bg-indigo-500 text-white py-2 px-4 rounded-md hover:bg-indigo-600">Add
                    Image</button>
            </div>
            ...
            <div class="mb-4">
                ...
                <input v-model="year" id="year" type="text" :class="{ 'border-red-500': errors.year }"
                    class="mt-1 block w-full border-gray-300 border-2 border-solid rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
            </div>
            <div class="mb-4">
